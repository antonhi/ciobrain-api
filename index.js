...
const peopleAssetController = require('./src/controller/peopleAssetController');
...
app.get("/asset/people/:id", peopleAssetController.findById);
...
app.get("/asset/people", peopleAssetController.findAll);
...
app.get("/asset/people/:id/children", peopleAssetController.findChildrenById);
